...
// import TranscriptionView from "./TranscriptionView"; // Импортируем компонент
...
//   const [selectedTranscription, setSelectedTranscription] = useState(null); // Состояние для выбранной транскрипции
...
//           onBack={() => setSelectedTranscription(null)} // Функция для возврата
//         />
//       );
//     }
